...
TEST(minijson_writer, escaping) {
  ...
  writer.write("int", 42);  // make sure the stream flags are correctly restored
                            // after writing hex values
  writer.close();
  ASSERT_EQ("{\"\\\\\\\"\\\"\\u0001\\u001f\\u007f\\n\\t\\r\":\"a\\\"\\\\b\","
            "\"int\":42}",
      stream.str());
...
TEST(minijson_writer, nesting_complex) {
  ...
  ASSERT_EQ("[\"value1\",{\"field2\":\"value2\",\"nested2\":[\"value3\","
            "\"value4\",[\"value5\",{}],\"value6\"],\"nestedempty\":[]}]",
      stream.str());
}
...
struct point_type_writer final {
      ...
      point_type value) /* intentionally non-const */
  {
    const char* str = "";
    switch (value) {
      case FIXED: str = "fixed"; break;
      case MOVING: str = "moving"; break;
    }
...
TEST(minijson_writer, long_strings) {
  ...
  writer.write("field6",
      "Aenean est mi, facilisis auctor tincidunt nec, ullamcorper ac ipsum. "
      ...
      "Morbi tincidunt orci vel porttitor fringilla. Nullam tristique justo ut "
      "ultricies tincidunt. "
      "Phasellus eu magna dolor. Mauris ut aliquet velit. Nullam id faucibus "
      "justo. "
      "Fusce ultricies blandit lacinia. Nulla auctor augue mi, sit amet "
      "consectetur ante imperdiet ac.");
